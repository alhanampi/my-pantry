...
export const schemes: Record<ColorScheme, SchemeConfig> = {
  green: {
    ...
    vars: {
      ...
      '--scheme-on-primary-muted': 'rgba(255,255,255,0.75)',
      '--scheme-on-primary-hover': 'rgba(255,255,255,0.15)',
      '--scheme-on-primary-search': 'rgba(255,255,255,0.18)',
      '--scheme-on-primary-search-focus': 'rgba(255,255,255,0.28)',
      '--scheme-on-primary-tabs': 'rgba(0,0,0,0.15)',
      '--scheme-on-primary-overlay': 'rgba(255,255,255,0.2)',
      '--scheme-hover-overlay': 'rgba(0,0,0,0.06)',
      '--scheme-swatch-active-border': 'rgba(0,0,0,0.45)',
      '--scheme-shadow-xs': 'rgba(0,0,0,0.08)',
      '--scheme-shadow-sm': 'rgba(0,0,0,0.25)',
      '--scheme-shadow-md': 'rgba(0,0,0,0.5)',
      '--scheme-error': '#c62828',
      '--scheme-error-light': '#ef9a9a',
      '--scheme-error-bg': '#ffebee',
      '--scheme-warning': '#e65100',
      '--scheme-info-light': '#90caf9',
      '--scheme-info-dark': '#1565c0',
      '--scheme-info-bg': '#e3f2fd',
    },
  },
  light: {
    labelEs: 'Claro',
  ...
  dark: {
    ...
    vars: {
      ...
      '--scheme-on-primary': '#e0e0e0',
      '--scheme-on-primary-muted': 'rgba(200,200,200,0.7)',
      '--scheme-on-primary-hover': 'rgba(255,255,255,0.1)',
      '--scheme-on-primary-search': 'rgba(255,255,255,0.1)',
      '--scheme-on-primary-search-focus': 'rgba(255,255,255,0.18)',
      '--scheme-on-primary-tabs': 'rgba(0,0,0,0.3)',
      '--scheme-on-primary-overlay': 'rgba(255,255,255,0.15)',
      '--scheme-hover-overlay': 'rgba(255,255,255,0.06)',
      '--scheme-swatch-active-border': 'rgba(255,255,255,0.55)',
      '--scheme-shadow-xs': 'rgba(0,0,0,0.15)',
      '--scheme-shadow-sm': 'rgba(0,0,0,0.25)',
      '--scheme-shadow-md': 'rgba(0,0,0,0.7)',
      '--scheme-error': '#ef5350',
      '--scheme-error-light': '#ef9a9a',
      '--scheme-error-bg': '#2a1515',
      '--scheme-warning': '#ff9800',
      '--scheme-info-light': '#bbdefb',
      '--scheme-info-dark': '#42a5f5',
      '--scheme-info-bg': '#1a2a3a',
    },
  },
  pink: {
    labelEs: 'Rosa',
